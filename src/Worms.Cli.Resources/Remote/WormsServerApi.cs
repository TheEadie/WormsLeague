...
internal sealed class WormsServerApi : IWormsServerApi
{
    ...
    {
        using var span = Telemetry.Source.StartActivity(Telemetry.Attributes.GetLatestCliDetails.SpanName);
    ...
    {
        using var span = Telemetry.Source.StartActivity(Telemetry.Attributes.DownloadLatestCLI.SpanName);
        _ = span?.AddTag(Telemetry.Attributes.DownloadLatestCLI.Platform, platform);
