...
internal class SchemeTextWriter : ISchemeTextWriter
{
    public void Write(Scheme definition, TextWriter textWriter)
    {
        ...
        WriteItem(textWriter, "Stockpiling mode", definition.Stockpiling, "Off | On | Anti");
        ...
        WriteItem(
            textWriter,
            "Phased Worms (Allied)",
            definition.Extended.WormPhasingAlly,
            "None | Worms | WormsWeapons | WormsWeaponsDamage");
        WriteItem(
            textWriter,
            "Phased Worms (Enemy)",
            definition.Extended.WormPhasingEnemy,
            "None | Worms | WormsWeapons | WormsWeaponsDamage");
        ...
        WriteItem(
            ...
            definition.Extended.KeepControlSkim,
            "Lost | Kept | KeptWithRope");
        ...
        WriteItem(
            ...
            definition.Extended.RwGravityType,
            "None | Default | BlackHoleConstant | BlackHoleLinear");
        ...
        WriteItem(
            ...
            definition.Extended.HealthCure,
            "Single | Team | Allies | Nobody");
