...
- [x] **Production deployment** — the SPA is built and deployed to production alongside the rest of the Hub, with CORS and authority configuration applied to the production environment.
